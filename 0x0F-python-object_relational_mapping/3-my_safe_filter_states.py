...
3. Execute an SQL query with a WHERE clause based on the provided name filter.
...
if __name__ == '__main__':
    ...
    # Execute an SQL query with a WHERE clause based on the provided name filte
    name_filter = argv[4]
    sql_query = "SELECT * FROM states WHERE BINARY name = %s"
    cur.execute(sql_query, [name_filter])
